...
class Presets(object):
    ...
    WELCOME_TEXT = "Hello.. <b>{}</b>\n<code><b>REQUESTED MOVIE 🎥🍿 NANBA SHARE OUR CHANNEL  from</code> OTT MOVIES - @TAMILROCKERSVPN1\n BACKUP_CHANNEL - @TRVPNMOVIES</b>  " \
    ...
    BOT_PM_TEXT = "<b>Sorry.. 😢</b>\n\n<code>Bot won't work in PM, Ask in ma Group @TAMILROCKERSVPN1. I'll reply the file in PM if " \
                  "available in our DB !</code>"
    PM_ERROR = "<b>Unable to send medias</b> ⛔️\n<code>Click the below button\nAsk here for movies later!</code>"
    MEDIA_SEND_TEXT = "<code><b>CLICK BELOW BUTTON NANBA<\b> 🥳</code>"
    NO_MEDIA = "Requested movie: <b>{}</b>\n\n<b>Not available✓WAIT TILL ADMIN COME TO ONLINE" \
